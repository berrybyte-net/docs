...
1. Make yourself an admin (see Soulmask admin setup guide)
...
1. Ensure you're an admin on the server
2. Open the console by pressing the `~` key in-game. 
3. Run the command: `RemoveServerPermissionList 1 <steamID>`

## Related Guides

- [Soulmask Introduction](/games/soulmask/introduction) - Learn more about Soulmask server hosting
