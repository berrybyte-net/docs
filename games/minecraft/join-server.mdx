...
Before you can join and connect to your [Minecraft server](https://berrybyte.net/minecraft-server-hosting), you'll need to find the [IP](https://whatismyipaddress.com/ip-address) (a combination of numbers, e.g `104.167.215.1`) or a subdomain (letters, e.g `test.berrybyte.net`).
