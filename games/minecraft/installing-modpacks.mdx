...
To get started with manual installation, first [upload the modpack's server archive](/panel/importing-files) (usually in a `.zip` format) to your file manager on the [game panel](https://game.berrybyte.net).
