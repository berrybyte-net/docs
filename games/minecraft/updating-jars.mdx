...
2. Stop your server and create a [backup](/panel/backups), just in case the update fails.
...
<Warning>
  If you're a BerryByte customer, you can alternatively copy the download URL
  ...
  guide](/panel/importing-files#download-files-from-url) for more information.
</Warning>

## Automatic update (Lime)

1. Stop your server.
2. [Create a backup](/panel/backups), just in case the update fails. You can do this by clicking
...
Feel free to create a [ticket](https://berrybyte.net/ticket) or join our
[Discord server](https://berrybyte.net/discord) if you have any questions or
need help.
