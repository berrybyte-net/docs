...
Alternatively, you can [restore a backup](/panel/backups#mounting) of those files or you can also make sure it's correctly formatted with a [json validator & formatter tool](https://jsonlint.com/) ensuring they have the `[]` symbol at the beginning and end of the files.
