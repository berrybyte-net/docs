...
If you wish to upload a singleplayer world from your computer to a [Minecraft server](https://berrybyte.net/minecraft-server-hosting), follow these steps: 
...
1. Stop the server
2. [Upload the world archive](/panel/importing-files) to the **File Manager** on the [game panel](https://game.berrybyte.net/)
...
- [Minecraft Introduction](/games/minecraft/introduction) - Learn more about Minecraft server hosting
