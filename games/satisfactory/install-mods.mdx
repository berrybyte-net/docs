...
While Satisfactory does not officially support mods, you can use the Satisfactory Mod Manager to install them on your server. You can download the Satisfactory Mod Manager from [this link](https://ficsit.app/).
