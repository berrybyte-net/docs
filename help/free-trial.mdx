...
BerryByte offers a **2-day free trial** to help you explore our game server hosting services before committing to a plan. This is the perfect way to test our platform, try different games, and see if our hosting meets your needs.
...
- Upgrades must be completed through the [client area](https://billing.berrybyte.net/login)
...
- [General Troubleshooting](/help/troubleshooting) - Fix common server issues
